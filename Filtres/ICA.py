...
ica.exclude = [0,1,2,3,4,6,7]  # Exclure les composantes
ica.apply(raw)
...
filtered_df.to_csv('C:\\Users\\PC\\Desktop\\EEG\\ENregistrement_artefacts\\ARTF\\FIltré\\Oculaire2.csv', index=False)
