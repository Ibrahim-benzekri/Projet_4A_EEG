...
# Définir l'électrode de l’oreille comme référence
raw.set_eeg_reference(ref_channels=["EEG-ch10"])
print(f"Custom reference applied? {raw.info['custom_ref_applied']}")
...
filtered_df.to_csv('C:\\Users\\PC\\Desktop\\EEG\\Codes\\Filtred_Tests\\passeband&rereference.csv', index=False)

print("Filtering and re-ref complete and saved'.")
